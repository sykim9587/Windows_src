...
void loop()
{
  TimePlot temp1("tem1"), temp2("tem2"), flexi1("flexi1"), flexi2("flexi2");
  temp1.SendData("temperature 1", mcp.readThermocouple()+5.5);
  temp2.SendData("temperature 2", mcp2.readThermocouple());
  FFdata1 = analogRead(FF1);
  FFdata2 = analogRead(FF2);
  vout31 = (FFdata1 * 3.3) / 1023.0;
  vout32 = (FFdata2 * 3.3) / 1023.0;
  vout31 = CF3 * vout31;
  vout32 = CF3 * vout32;
  flexi1.SendData("Flexiforce 1", vout31);
